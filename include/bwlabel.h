...
namespace qrcode {
	...
	//void bwlabel(Engine * engine, Eigen::MatrixXi & bw, int connectivity, Eigen::MatrixXi & label, int label_num);

	void labelNum(Eigen::MatrixXi & label, int & n, std::vector<int> & num);
	void labelNum(Eigen::MatrixXi & label, std::vector<int>& num);
	void bwlabel(Engine * engine, Eigen::MatrixXi & bw, int connectivity, Eigen::MatrixXi & label, std::vector<int>& num);
	/*exterior bound*/
